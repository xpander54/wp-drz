...
<div class="columns reversed">
	<ul>
		<li class="col-1-2">
			...
			<p class="text-right cart">
				<a class="checkout-button button big" onclick="jQuery('[name=&quot;proceed&quot;]').click(); return false;" style="border-color: #129a00; color: #129a00;"><span><?php _e('Proceed to Checkout', 'woocommerce'); ?></span><i class="icon-right-bold"></i></a>
			</p>
		</li>
		<li class="col-1-2">
